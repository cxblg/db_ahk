...
;WinGetPos, posX, posY,,,ahk_class Sandbox:2cc4:TForm1
;msgbox, %posX% %posY%
if (A_Index = 1)
{
kotakX1 := posX + 59, kotakY1 := posY + kuda_posY + 104
kotakX2 := posX + 158, kotakY2 := posY + kuda_posY + 142
}
if (A_Index = 2)
{
kotakX1 := posX + 164, kotakY1 := posY + kuda_posY + 104
kotakX2 := posX + 258, kotakY2 := posY + kuda_posY + 142
}
if (A_Index = 3)
{
kotakX1 := posX + 264, kotakY1 := posY + kuda_posY + 104
kotakX2 := posX + 358, kotakY2 := posY + kuda_posY + 142
}

if (A_Index = 4)
{
kotakX1 := posX + 59, kotakY1 := posY + kuda_posY + 204
kotakX2 := posX + 158, kotakY2 := posY + kuda_posY + 242
}
if (A_Index = 5)
{
kotakX1 := posX + 164, kotakY1 := posY + kuda_posY + 204
kotakX2 := posX + 258, kotakY2 := posY + kuda_posY + 242
}
if (A_Index = 6)
{
kotakX1 := posX + 264, kotakY1 := posY + kuda_posY + 204
kotakX2 := posX + 358, kotakY2 := posY + kuda_posY + 242
}
UrlDownloadToFile, https://www.mediafire.com/file/jtu6dwjd23wkq9s/db_kudaOnline.txt/file, E:\AHK\OCR\Kuda\debeKuda.txt
#Include, db_kuda.txt


if (ok:=FindText(X, Y, kotakX1, kotakY1, kotakX2, kotakY2, 0, 0, Text))
{
  ; FindText.Click(X, Y, "L")

  ; Rumus ( X, Y = titik terdeteksi || posX, posY = posisi windows)
  CCposX := X - posX
  CCposY := Y - posY
  Controlclick, x%CCposX% y%CCposY%, ahk_class %class%,,,, NA
  ;MouseMove X, Y
}
